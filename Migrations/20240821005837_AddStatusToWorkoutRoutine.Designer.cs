...
namespace GymQuest.Migrations
{
    ...
    [Migration("20240821005837_AddStatusToWorkoutRoutine")]
    partial class AddStatusToWorkoutRoutine
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GymQuest.Models.PlannedExercises", b =>
                {
                    ...
                    b.Property<int?>("WorkoutDaysWorkoutDayId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("WorkoutDaysWorkoutDayId");
            ...
            modelBuilder.Entity("GymQuest.Models.WorkoutDays", b =>
                {
                    ...
                    b.Property<int?>("WorkoutRoutinesWorkoutRoutineId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("WorkoutRoutinesWorkoutRoutineId");
            ...
            modelBuilder.Entity("GymQuest.Models.PlannedExercises", b =>
                {
                    ...
                    b.HasOne("GymQuest.Models.WorkoutDays", "WorkoutDays")
                        ...
                        .HasForeignKey("WorkoutDaysWorkoutDayId");
            ...
            modelBuilder.Entity("GymQuest.Models.WorkoutDays", b =>
                {
                    ...
                    b.HasOne("GymQuest.Models.WorkoutRoutines", null)
                        .WithMany("WorkoutDays")
                        .HasForeignKey("WorkoutRoutinesWorkoutRoutineId");
